...
import 'package:doctor_appointment_app/dbHelper/update_data.dart';
import 'package:doctor_appointment_app/mixins/validation_mixin.dart';
      ...
      child: RaisedButton(
        ...
        onPressed: () {
          if (formKey.currentState.validate()) {
            ...
            SearchService().searchUserById(user.kimlikNo).then(
              (QuerySnapshot docs) {
