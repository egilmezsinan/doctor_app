...
import 'package:doctor_appointment_app/ui/admin/show_appo_times_forAdmin.dart';
...
class OpenAppointmentState extends State<OpenAppointment> {
  ...
  Widget build(BuildContext context) {
    setState(
      () {
        Firestore.instance.collection('tblAdmin').getDocuments().then(
          (QuerySnapshot docs) {
